...
class Player:
    def __init__(self, chat_id, username: str = None, friendlist=None, items=None, pokemon=None, pokemon_team=None,
        ...
        self.pokemon: List[int] = [] if pokemon is None else pokemon
        self.pokemon_team: List[int] = [] if pokemon_team is None else pokemon_team
    ...
    def serialize(self):
        serial = {'_id': self.chat_id,
                  ...
                  'items': self.items,
                  'pokemon': [i for i in self.pokemon],
                  'pokemon_team': [i for i in self.pokemon_team],
