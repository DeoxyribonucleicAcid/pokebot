...
def send_lang_menu(bot, chat_id):
    ...
    msg = bot.send_message(chat_id=chat_id, text=get_text(player, 'choose_language_msg'), reply_markup=reply_markup)
...
def change_lang(bot, chat_id, chosen_lang):
    ...
    bot.send_message(chat_id=chat_id, text=get_text(player, 'language_updated_msg'))
